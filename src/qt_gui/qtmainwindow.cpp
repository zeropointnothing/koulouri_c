...
// void QtQtMainWindow::startPlayback() {
//     // const std::string PATH = "/home/exii/Music/kessoku band/Re-Kessoku Band/06 - Re_Re_.mp3";
//     // const std::string PATH = "/home/exii/Music/STARSET/Starset - Vessels/Starset - Vessels - 12 Unbecoming.flac";
//     const std::string PATH = "/home/exii/Music/Wuthering Waves/Against The Tide/Wuthering Waves - Against The Tide - 01 Against the Tide.m4a";
//     // const std::string PATH = "/home/exii/Music/Wuthering Waves/Dreams of the Deep/Wuthering Waves - Dreams of the Deep - 03 - Reveries in the Crimson Beyond.m4a";
//     qDebug() << "clicked start!.";

//     ui->progressBar->setRange(0,0); // enable intermediate mode
...
//             QMessageBox msg;
//             std::string error = "Koulouri was unable to open the file '"+PATH+"' ("+result.getFriendly()+")";
//             msg.critical(0, "Failed to open file!", error.c_str());
